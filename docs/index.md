...
Ce site s'adresse aux secondes 2GT2 du lycée Notre Dame du Mur de MORLAIX pour l'enseignement des Sciences Numériques et Technologie.
...
=== "CONTENU DE SÉANCE"
    ...
    - **Compléter** et **rendre** le notebook d'[introduction à l'Intelligence Artificielle sur Capytale n°`79b3-10163070](https://capytale2.ac-paris.fr/web/c/79b3-10163070){target="_blank"} ;
    
    - **Développer** vos compétences en IA sur PIX :
        - [Décrypter le fonctionnement et les enjeux de l'IA](https://app.pix.fr/parcours/QJEPVZ381){target="_blank"},
        - [Utiliser l’IA générative de façon éclairée et efficace](https://app.pix.fr/parcours/UNMNZD975){target="_blank"} ;

    - **Réaliser** [le parcours ELEA de programmation IAssistée](https://bzh-29-nord.elea.apps.education.fr/course/section.php?id=22144){target="_blank"} ;
...
=== "CONTENU DE SÉANCE"
    ...
    - Evaluation sur les [données structurées](./DS/#bilan) ;
    
    - **Finir** pour le 20/02 votre découverte de la manipulation de données sur [la plateforme France-IOI](https://concours.castor-informatique.fr/){target=_blank} avec les codes :
...
=== "TRAVAIL À FAIRE"      
    ...
    - **Développer** vos compétences dans le domaine des données structurées en suivant [le parcours `MWEAGK692` sur PIX](https://app.pix.fr/campagnes/MWEAGK692){target="_blank"} ;    
...
=== "CONTENU DE SÉANCE"
    ...
    - **Découvrir** le traitement de données structurées en tables sur [la plateforme France-IOI](https://concours.castor-informatique.fr/){target=_blank} avec le code `d4hy533r` pour l'activité n°2 ;
...
=== "CONTENU DE SÉANCE"
    ...
    - **Découvrir** la manipulation de données sur [la plateforme France-IOI](https://concours.castor-informatique.fr/){target=_blank} avec le code `4xrbqtn3` pour l'activité n°1 ;
...
=== "TRAVAIL À FAIRE"
    ...
    - **Finir** puis **rendre** le travail demandé sur le notebook [Capytale n°`efb8-11440092`](https://capytale2.ac-paris.fr/web/c/efb8-11440092){target=_blank} ;
  
    - **Poursuivre** votre [prise en main](https://ec-morlaix.forge.apps.education.fr/infos/priseenmain/){:target="_blank"} de l'E.N.T. avec l'iPad ;
    
    - Prolongement, se questionner encore sur l'IA avec EGO :
    
    <center><iframe width="560" height="315" src="https://www.youtube.com/embed/ZP7T6WAK3Ow?si=Yjf1tL3V-UpwJbvl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></center>
